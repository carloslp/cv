...
export const RESUME_DATA = {
  ...
  en: {
    ...
    about: "Chief Solutioning Coppel Argentina.",
    summary:
      "I am passionate about learning new technologies and applying them to solve real-world problems. I value teamwork, innovation, and customer satisfaction. I can bring diverse perspectives and experiences to the team. I also facilitate agile methodologies and practices to ensure timely and quality delivery of project results. I collaborate and communicate with different stakeholders, such as developers, testers, business analysts, and operations managers, to understand their needs, expectations, and feedback.",
    avatarUrl: "https://github.com/carloslp/cv/blob/00c48d9ec3543941b119012e7d178a4edce8f6ca/src/data/profile.jpeg?raw=true",
    personalWebsiteUrl: "https://juanlopez.dev",
    contact: {
      email: "me@juanlopez.dev",
    ...
    education: [
      ...
      {
        school: "Instituto Tecnológico Superior de Guasave",
        degree: "Computer Systems Engineering, Databases",
        start: "2014",
        end: "2018",
      },
    ],
    work: [
      {
        ...
        link: "https://coppel.com",
        badges: [],
        title: "Chief Solutioning / Solutions Architect Manager",
        logo: null,
        start: "Jul 2024",
        end: null,
        description: "",
      ...
      {
        company: "El Tiempo Periódico de Sinaloa · Freelancer",
        link: "https://eltiempodesinaloa.com/",
        badges: ["Remote"],
        title: "IT Assistant",
        logo: null,
    ...
    projects: [
      {
        title: "On-premise to GCP Cloud Migration",
        techStack: ["Project Lead","GKE", "Docker"],
        description: "Service migration",
        logo: Minimal,
        link: {
          label: "useminimal.com",
          href: "https://useminimal.com/",
      ...
      {
        title: "Store Inventory PDA Migration",
        techStack: ["Project Lead", "Android", "PHP"],
        description: "Migration from Windows Mobile PDA to Android.",
        logo: null
      },
      {
        title: "Automated Inventories and Web Label Reprinting",
        techStack: ["Project Lead", "Angular", "PHP", "Microservices"],
        description: "Tool for unscheduled clothing inventory and on-demand web label migration.",
        logo: null
      },
      {
        title: "Manager Fingerprint Delegation Admin",
        techStack: ["Project Lead", "Angular", "PHP", "C++","PostgreSQL","Microservices"],
        description: "Temporary manager permissions admin for specific employees.",
        logo: null
      },
      {
        title: "Credit Application and CAT Calls Migration",
        techStack: ["Project Lead", "PHP","JavaScript", "C++","PostgreSQL"],
        description: "Vulnerability remediation following n-2, OS and language updates.",
        logo: null,
      },
      {
        title: "MercadoPago QR at POS",
        techStack: ["Software Architect", "Angular","TypeScript", "C++", "Java", "PostgreSQL", "Docker"],
        description: "Architecture definition and MercadoPago QR integration at Coppel POS.",
        logo: null,
      },
      {
        title: "Coppel Credit (Argentina) on the Web",
        techStack: ["Software Architect","C++", "Java", "PostgreSQL"],
        description: "Architecture definition and API coding for Coppel client credit sales online.",
        logo: null,
      },
      {
        title: "Affiliate Discounts Integration",
        techStack: ["Developer","Angular", "TypeScript", "C++","PostgreSQL"],
        description: "Module to apply affiliate discounts to clothing and furniture items.",
        logo: null,
      },
      {
        title: "Store Systems Unification",
        techStack: ["Developer","Angular", "TypeScript", "C++", "Nginx", "PostgreSQL"],
        description: "Unification of clothing and furniture sales systems, plus complementary sales module.",
        logo: null,
      },
      {
        title: "El Tiempo Periódico de Sinaloa",
    ...
    certifications: [
      {
        title: "Cloud Digital Leader Certification",
        description: "A Cloud Digital Leader can clearly articulate the capabilities of Google Cloud's core products and services and how organizations benefit from them.",
        techStack: ["Artificial Intelligence (AI)", "Cloud Computing", "Cloud Digital Leader", "Cloud Security", "Data Governance", "Digital Transformation", "Google Cloud", "Google Cloud Platform (GCP)", "Security and Trust"],
        link: {
          label: "www.credly.com",
          href: "https://www.credly.com/badges/03b321ec-4018-49bc-8b7a-f7b689df115c/linked_in?t=sxgblq"
      ...
      },
      {
        ...
        description: "Introduces concepts such as software as a service (SaaS), platform as a service (PaaS), and infrastructure as a service (IaaS) and the different deployment models available.",
        techStack: ["Cloud Security", "Cybersecurity"],
        link: {
          label: "linkedin.com",
          href: "https://www.linkedin.com/learning/certificates/8e031a17e192f2bdabae652f7e68b1000c3f525cd133cac5fe86f56dc0929172?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_certifications_details%3Bg6LmFkYKTleD4RjrM70hxA%3D%3D"
        }
